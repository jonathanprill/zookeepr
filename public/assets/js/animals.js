...
//handleGetAnimalsSubmit function will gather all of the form input data and package it as an object to send to this function as the formData argument.
const getAnimals = (formData = {}) => {
  ...
  .then(animalData => {
    ...
    //sending our array of animal data to the printResults() function
